--SELECT * FROM film WHERE length BETWEEN 100 AND 149

--SELECT title FROM film WHERE rental_duration BETWEEN 3 AND 5
...
SELECT * FROM film WHERE replacement_cost BETWEEN 12.99 AND 16.98 --16.99 DESEYDİK 16.99'u DA DAHİL EDERDİ AMA BİZDEN BUNU İSTEMEDİĞİ 
--İÇİN BİR KÜÇÜK DEĞERİNİ ALDIK
