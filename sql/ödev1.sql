...
SELECT * FROM film WHERE NOT rental_rate=2.99;
SELECT * FROM film WHERE NOT (rental_rate=2.99 OR rental_rate=4.99)

--film tablosunda bulunan title ve description sütunlarındaki verileri sıralayınız.
SELECT title,description FROM film;
--film tablosunda bulunan tüm sütunlardaki verileri film uzunluğu (length) 60 dan büyük VE 75 
--ten küçük olma koşullarıyla sıralayınız.
